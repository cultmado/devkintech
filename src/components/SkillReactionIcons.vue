...
const props = defineProps({
  skills: {
    ...
    default: () => [
      ...
      { key: 'react', src: 'assets/icons/react.svg' },
      { key: 'vite', src: 'assets/icons/vite.svg' },
      { key: 'vim', src: 'assets/icons/vim.svg' },
      { key: 'ubuntu', src: 'assets/icons/ubuntu.svg' },
      { key: 'sqlite', src: 'assets/icons/sqlite.svg' },
      { key: 'powershell', src: 'assets/icons/powershell.svg' },
      { key: 'postman', src: 'assets/icons/postman.svg' },
      { key: 'pinia', src: 'assets/icons/pinia.svg' },
      { key: 'php', src: 'assets/icons/php.svg' },
      { key: 'npm', src: 'assets/icons/npm.svg' },
      { key: 'nodejs', src: 'assets/icons/nodejs.svg' },
      { key: 'jquery', src: 'assets/icons/jquery.svg' },
      { key: 'java', src: 'assets/icons/java.svg' },
      { key: 'html', src: 'assets/icons/html.svg' },
      { key: 'gitlab', src: 'assets/icons/gitlab.svg' },
      { key: 'githubactions', src: 'assets/icons/githubactions.svg' },
      { key: 'github', src: 'assets/icons/github.svg' },
      { key: 'git', src: 'assets/icons/git.svg' },
      { key: 'gcp', src: 'assets/icons/gcp.svg' },
      { key: 'figma', src: 'assets/icons/figma.svg' },
      { key: 'dotnet', src: 'assets/icons/dotnet.svg' },
      { key: 'csharp', src: 'assets/icons/csharp.svg' },
      { key: 'cpp', src: 'assets/icons/cpp.svg' },
      { key: 'cloudflare', src: 'assets/icons/cloudflare.svg' },
      { key: 'bootstrap', src: 'assets/icons/bootstrap.svg' },
      { key: 'bash', src: 'assets/icons/bash.svg' },
      { key: 'aws', src: 'assets/icons/aws.svg' },
      { key: 'angular', src: 'assets/icons/angular.svg' },
      { key: 'androidstudio', src: 'assets/icons/androidstudio.svg' },
      { key: 'alpinejs', src: 'assets/icons/alpinejs.svg' },
      { key: 'vscode', src: 'assets/icons/vscode.svg' },
      { key: 'visualstudio', src: 'assets/icons/visualstudio.svg' },
    ],
  },
...
function drawLinksAndPropagate() {
  ...
  for (let i = 0; i < nodes.length; i++) {
    for (let j = i + 1; j < nodes.length; j++) {
      ...
      ctx.strokeStyle = `rgba(148,163,184,${0.1 + proximity * 0.42 + energy * 0.55})`
      ...
      if (a.energy > b.energy + 0.12)
        b.energy = Math.min(1, b.energy + transfer * (a.energy - b.energy))
      else if (b.energy > a.energy + 0.12)
        a.energy = Math.min(1, a.energy + transfer * (b.energy - a.energy))
